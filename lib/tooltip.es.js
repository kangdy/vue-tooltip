...
var tooltip_vue_vue_type_style_index_1_scoped_true_lang = "";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      (_a = tooltipRef.value) == null ? void 0 : _a.style.setProperty("-webkit-line-clamp", String(props.line));
    });
    ...
    function createTooltip(el) {
      ...
      tooltipDom.innerHTML = `${(_a = props.text) != null ? _a : el.innerText}<div id="v-arrow" data-popper-arrow></div>`;
...
var tooltip = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5627c528"]]);
tooltip.install = (App) => {
