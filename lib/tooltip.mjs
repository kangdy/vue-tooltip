...
var T = "top", N = "bottom", L = "right", k = "left", we = "auto", ce = [T, N, L, k], Z = "start", fe = "end", Et = "clippingParents", rt = "viewport", ae = "popper", At = "reference", Xe = /* @__PURE__ */ ce.reduce(function(t, e) {
  return t.concat([e + "-" + Z, e + "-" + fe]);
}, []), nt = /* @__PURE__ */ [].concat(ce, [we]).reduce(function(t, e) {
  return t.concat([e, e + "-" + Z, e + "-" + fe]);
}, []), Pt = "beforeRead", Rt = "read", Dt = "afterRead", St = "beforeMain", jt = "main", Tt = "afterMain", kt = "beforeWrite", Bt = "write", Ct = "afterWrite", De = [Pt, Rt, Dt, St, jt, Tt, kt, Bt, Ct];
function I(t) {
...
function te(t, e, r) {
  ...
  var p = K(t) ? $(t) : window, f = p.visualViewport, s = !ot() && r, c = (n.left + (s && f ? f.offsetLeft : 0)) / o, a = (n.top + (s && f ? f.offsetTop : 0)) / i, u = n.width / o, h = n.height / i;
  return {
    width: u,
    height: h,
    top: a,
...
function qt(t) {
  var e, r = t.state, n = t.name, o = t.options, i = r.elements.arrow, p = r.modifiersData.popperOffsets, f = _(r.placement), s = Be(f), c = [k, L].indexOf(f) >= 0, a = c ? "height" : "width";
  if (!(!i || !p)) {
    var u = It(o.padding, r), h = ke(i), l = s === "y" ? T : k, w = s === "y" ? N : L, g = r.rects.reference[a] + r.rects.reference[s] - p[s] - r.rects.popper[a], m = p[s] - r.rects.reference[s], x = le(i), A = x ? s === "y" ? x.clientHeight || 0 : x.clientWidth || 0 : 0, E = g / 2 - m / 2, v = u[l], y = A - h[a] - u[w], d = A / 2 - h[a] / 2 + E, O = ie(v, d, y), P = s;
...
function Ue(t) {
  var e, r = t.popper, n = t.popperRect, o = t.placement, i = t.variation, p = t.offsets, f = t.position, s = t.gpuAcceleration, c = t.adaptive, a = t.roundOffsets, u = t.isFixed, h = p.x, l = h === void 0 ? 0 : h, w = p.y, g = w === void 0 ? 0 : w, m = typeof a == "function" ? a({
    x: l,
    y: g
  }) : {
    x: l,
  ...
  if (c) {
    ...
    if (d === $(r) && (d = H(r), V(d).position !== "static" && f === "absolute" && (O = "scrollHeight", P = "scrollWidth")), d = d, o === T || (o === k || o === L) && i === fe) {
      v = N;
      var R = u && d === y && y.visualViewport ? y.visualViewport.height : (
        // $FlowFixMe[prop-missing]
        d[O]
      );
      g -= R - n.height, g *= s ? 1 : -1;
    }
    if (o === k || (o === T || o === N) && i === fe) {
      E = L;
      var D = u && d === y && y.visualViewport ? y.visualViewport.width : (
        // $FlowFixMe[prop-missing]
        d[P]
      );
      l -= D - n.width, l *= s ? 1 : -1;
  ...
  if (l = S.x, g = S.y, s) {
    var j;
    return Object.assign({}, b, (j = {}, j[v] = A ? "0" : "", j[E] = x ? "0" : "", j.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + l + "px, " + g + "px)" : "translate3d(" + l + "px, " + g + "px, 0)", j));
  }
  return Object.assign({}, b, (e = {}, e[v] = A ? g + "px" : "", e[E] = x ? l + "px" : "", e.transform = "", e));
}
function Yt(t) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    p && ["transform", "top", "right", "bottom", "left"].some(function(u) {
...
function pe(t, e) {
  e === void 0 && (e = {});
  var r = e, n = r.placement, o = n === void 0 ? t.placement : n, i = r.strategy, p = i === void 0 ? t.strategy : i, f = r.boundary, s = f === void 0 ? Et : f, c = r.rootBoundary, a = c === void 0 ? rt : c, u = r.elementContext, h = u === void 0 ? ae : u, l = r.altBoundary, w = l === void 0 ? !1 : l, g = r.padding, m = g === void 0 ? 0 : g, x = st(typeof m != "number" ? m : ft(m, ce)), A = h === ae ? At : ae, E = t.rects.popper, v = t.elements[w ? A : h], y = rr(K(v) ? v : v.contextElement || H(t.elements.popper), s, a, p), d = te(t.elements.reference), O = ct({
    reference: d,
    element: E,
    strategy: "absolute",
    placement: o
  }), P = je(Object.assign({}, E, O)), R = h === ae ? P : d, D = {
    top: y.top - R.top + x.top,
    bottom: R.bottom - y.bottom + x.bottom,
    left: y.left - R.left + x.left,
    right: R.right - y.right + x.right
  }, b = t.modifiersData.offset;
  if (h === ae && b) {
    var S = b[o];
    Object.keys(D).forEach(function(j) {
      var F = [L, N].indexOf(j) >= 0 ? 1 : -1, X = [T, N].indexOf(j) >= 0 ? "y" : "x";
      D[j] += S[X] * F;
    });
  }
  return D;
...
function nr(t, e) {
  e === void 0 && (e = {});
  var r = e, n = r.placement, o = r.boundary, i = r.rootBoundary, p = r.padding, f = r.flipVariations, s = r.allowedAutoPlacements, c = s === void 0 ? nt : s, a = re(n), u = a ? f ? Xe : Xe.filter(function(w) {
    return re(w) === a;
  }) : ce, h = u.filter(function(w) {
  ...
  return Object.keys(l).sort(function(w, g) {
    return l[w] - l[g];
  });
}
function or(t) {
...
function ar(t) {
  ...
  if (!e.modifiersData[n]._skip) {
    for (var o = r.mainAxis, i = o === void 0 ? !0 : o, p = r.altAxis, f = p === void 0 ? !0 : p, s = r.fallbackPlacements, c = r.padding, a = r.boundary, u = r.rootBoundary, h = r.altBoundary, l = r.flipVariations, w = l === void 0 ? !0 : l, g = r.allowedAutoPlacements, m = e.options.placement, x = _(m), A = x === m, E = s || (A || !w ? [ye(m)] : or(m)), v = [m].concat(E).reduce(function(Q, q) {
    ...
    }, []), y = e.rects.reference, d = e.rects.popper, O = /* @__PURE__ */ new Map(), P = !0, R = v[0], D = 0; D < v.length; D++) {
      var b = v[D], S = _(b), j = re(b) === Z, F = [T, N].indexOf(S) >= 0, X = F ? "width" : "height", B = pe(e, {
        placement: b,
        boundary: a,
        rootBoundary: u,
        altBoundary: h,
...
function Ke(t) {
  return [T, L, N, k].some(function(e) {
    return t[e] >= 0;
  });
}
function sr(t) {
  var e = t.state, r = t.name, n = e.rects.reference, o = e.rects.popper, i = e.modifiersData.preventOverflow, p = pe(e, {
    ...
    altBoundary: !0
  }), s = Je(p, n), c = Je(f, o, i), a = Ke(s), u = Ke(c);
  e.modifiersData[r] = {
...
function pr(t, e, r) {
  ...
  return p = p || 0, f = (f || 0) * o, [k, L].indexOf(n) >= 0 ? {
    x: f,
    y: p
  } : {
    x: p,
...
function cr(t) {
  var e = t.state, r = t.options, n = t.name, o = r.offset, i = o === void 0 ? [0, 0] : o, p = nt.reduce(function(a, u) {
    return a[u] = pr(u, e.rects, i), a;
...
function mr(t) {
  var e = t.state, r = t.options, n = t.name, o = r.mainAxis, i = o === void 0 ? !0 : o, p = r.altAxis, f = p === void 0 ? !1 : p, s = r.boundary, c = r.rootBoundary, a = r.altBoundary, u = r.padding, h = r.tether, l = h === void 0 ? !0 : h, w = r.tetherOffset, g = w === void 0 ? 0 : w, m = pe(e, {
    boundary: s,
    rootBoundary: c,
    padding: u,
    altBoundary: a
  }), x = _(e.placement), A = re(e.placement), E = !A, v = Be(x), y = dr(v), d = e.modifiersData.popperOffsets, O = e.rects.reference, P = e.rects.popper, R = typeof g == "function" ? g(Object.assign({}, e.rects, {
    placement: e.placement
  })) : g, D = typeof R == "number" ? {
    mainAxis: R,
    altAxis: R
    ...
    mainAxis: 0,
    altAxis: 0
  }, R), b = e.modifiersData.offset ? e.modifiersData.offset[e.placement] : null, S = {
    x: 0,
    y: 0
  };
  if (d) {
    if (i) {
      var j, F = v === "y" ? T : k, X = v === "y" ? N : L, B = v === "y" ? "height" : "width", M = d[v], ue = M + m[F], Y = M - m[X], ve = l ? -P[B] / 2 : 0, Oe = A === Z ? O[B] : P[B], ne = A === Z ? -P[B] : -O[B], de = e.elements.arrow, Q = l && de ? ke(de) : {
        width: 0,
        height: 0
      }, q = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : it(), oe = q[F], me = q[X], U = ie(0, O[B], Q[B]), Ee = E ? O[B] / 2 - ve - U - oe - D.mainAxis : Oe - U - oe - D.mainAxis, lt = E ? -O[B] / 2 + ve + U + me + D.mainAxis : ne + U + me + D.mainAxis, Ae = e.elements.arrow && le(e.elements.arrow), ut = Ae ? v === "y" ? Ae.clientTop || 0 : Ae.clientLeft || 0 : 0, $e = (j = b == null ? void 0 : b[v]) != null ? j : 0, vt = M + Ee - $e - ut, dt = M + lt - $e, Me = ie(l ? be(ue, vt) : ue, M, l ? J(Y, dt) : Y);
      d[v] = Me, S[v] = Me - M;
    }
    if (f) {
      var _e, mt = v === "x" ? T : k, ht = v === "x" ? N : L, z = d[y], he = y === "y" ? "height" : "width", Ve = z + m[mt], Ie = z - m[ht], Pe = [T, k].indexOf(x) !== -1, qe = (_e = b == null ? void 0 : b[y]) != null ? _e : 0, We = Pe ? Ve : z - O[he] - P[he] - qe + D.altAxis, He = Pe ? z + O[he] + P[he] - qe - D.altAxis : Ie, Fe = l && Pe ? Vt(We, z, He) : ie(l ? We : Ve, z, l ? He : Ie);
      d[y] = Fe, S[y] = Fe - z;
    }
    e.modifiersData[n] = S;
  }
...
function jr(t) {
  ...
  return function(f, s, c) {
    ...
    var a = {
      ...
      setOptions: function(x) {
        ...
        if (a.orderedModifiers = E.filter(function(b) {
          ...
          var v = Rr([].concat(E, a.options.modifiers), function(b) {
            var S = b.name;
            return S;
          });
          ...
          var d = V(s), O = d.marginTop, P = d.marginRight, R = d.marginBottom, D = d.marginLeft;
          [O, P, R, D].some(function(b) {
            return parseFloat(b);
      ...
      forceUpdate: function() {
        if (!h) {
          ...
          for (var v = 0, y = 0; y < a.orderedModifiers.length; y++) {
            ...
            var d = a.orderedModifiers[y], O = d.fn, P = d.options, R = P === void 0 ? {} : P, D = d.name;
    ...
    l.setOptions(c).then(function(m) {
...
const Br = /* @__PURE__ */ gt({
  ...
  setup(t) {
    ...
    function o(a) {
      const u = a.target, h = new Range();
      h.selectNodeContents(u);
      const l = h.getBoundingClientRect(), w = u.getBoundingClientRect();
      (l.width > w.width || e.prompt) && p(u);
    }
    function i() {
      f();
    ...
    function p(a) {
      s(), r.classList.remove("light", "dark"), r.classList.add(e.theme), r.innerHTML = `${e.text ?? a.innerText}<div id="v-arrow" data-popper-arrow></div>`, e.tooltipStyle && Object.entries(e.tooltipStyle).forEach((u) => {
        c(r, ...u);
      }), kr(a, r, {
        placement: e.placement
      });
...
const Cr = (t, e) => {
  ...
  for (const [n, o] of e)
    r[n] = o;
  return r;
}, Re = /* @__PURE__ */ Cr(Br, [["__scopeId", "data-v-61d325a7"]]);
Re.install = (t) => {
